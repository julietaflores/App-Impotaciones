...
@Component({
  selector: 'app-registro-imagen-y-comentario-fnc-dos',
  templateUrl: './registro-imagen-y-comentario-fnc-dos.page.html',
  styleUrls: ['./registro-imagen-y-comentario-fnc-dos.page.scss'],
})
export class RegistroImagenYComentarioFncDosPage implements OnInit {
  DocEntry:any='';
  Estado:any='';
  images: any[] = [];
  short_message: any = '';
  ...
  callApi() {
    ...
    const param = {
      ...
      this.api.insert_datos_json('insertar_detalle_factura_ya_no_es_primero', param).then((data_001: any) => {
